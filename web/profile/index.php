...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-12 profile-pic-container d-flex flex-column justify-content-center align-items-center">
                <?php
            ...
            <div class="col-lg-8 col-md-7 col-12 profile-data-container">
                    ...
                    <div class="row text-center mb-4">
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                            <div class="stat-card p-4 h-100">
                                <h3 class="font-title" id="stat-points">-</h3>
                ...
                <div class="change-pw container mt-4">
                    <h1 class="mb-3 font-title">Change password</h1>
                    <hr>
                    <h4 class="text-success d-none bg-light font-normal p-2" id="password-changed">Password changed
                        successfully!</h4>
                    <div class="row">
                        <div class="col-md-8 col-lg-6 mx-auto">
                            <div class="mb-3">
                                ...
                                <p class="text-danger d-none mt-1" id="incorrect-password">Incorrect password!</p>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-danger d-none mt-1" id="password-mismatch">Passwords do not match!</p>
                            </div>
                            <button type="button" class="btn btn-secondary font-normal mb-5"
                                id="credential-submit-button" onclick="changePassword()">Change</button>
                        </div>
                    </div>
                </div>
            </div>
